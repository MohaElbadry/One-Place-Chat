...
\usepackage{changepage}        % For adjusti{\tiny }ng page margins
...
% ---------Page De Garde---------
	\includepdf[pages=-]{pages/page_de_garde.pdf}
	...
	\include{pages/06-mcp-presentation.tex}	
	\include{pages/07-problem-solution.tex}
	\include{pages/08-architecture-stack.tex}
	\include{pages/09-realisation-opc.tex}
